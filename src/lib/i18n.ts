...
export const translations = {
  en: {
    ...
    tabs: {
      ...
      product_strategy: 'Strategy Coach',
    },
    input: {
      placeholder: {
        ...
        growth_coach: 'Ask a follow-up about your growth diagnostic...',
        product_strategy: 'Ask a follow-up about your strategy diagnostic...',
      },
    ...
    job_match: {
      ...
      detail_search_google: 'Search on Google',
      detail_via: 'via {source}',
      posted_at: 'Posted {time}',
      ask_lenny: "Ask Lenny",
      lennys_take: "Lenny's Take",
      lenny_loading: "Loading insights from Lenny's archive...",
      lenny_error: "Couldn't load Lenny's advice. The knowledge base may be unavailable.",
      lenny_retry: 'Retry',
    ...
    growth_coach: {
      wizard_title: 'Growth Diagnostic',
      wizard_subtitle: "Answer a few questions about your product and growth challenges. I'll analyze them against Lenny's 78+ growth episodes and articles to produce a personalized diagnostic report.",
      field_product_type: 'Product Type',
      field_product_desc: 'Product Description',
      field_product_desc_placeholder: 'Briefly describe what your product does and who it serves...',
      field_growth_stage: 'Current Growth Stage',
      field_challenges: 'Core Growth Challenges',
      field_challenges_hint: 'Select all that apply, or add your own',
      field_metrics: 'Key Metrics (Optional)',
      field_dau: 'DAU',
      field_mau: 'MAU',
      field_d30_retention: 'D30 Retention',
      field_conversion: 'Conversion Rate',
      field_revenue: 'MRR / Revenue',
      run_diagnostic: 'Run Growth Diagnostic',
      report_title: 'Growth Diagnostic Report',
      report_generating: 'Generating your diagnostic report...',
      report_done: 'Diagnostic complete',
      start_chat: 'Continue with Follow-up Chat',
      back_to_wizard: 'Edit Inputs',
      new_diagnostic: 'New Diagnostic',
    },
    product_strategy: {
      wizard_title: 'Product Strategy Diagnostic',
      wizard_subtitle: "Describe your product and strategy challenges. I'll analyze them against Lenny's 130+ product strategy episodes and articles to produce a personalized diagnostic report.",
      field_strategy_area: 'Strategy Area',
      field_product_desc: 'Product Description',
      field_product_desc_placeholder: 'What does your product do and who does it serve?',
      field_product_maturity: 'Product Maturity',
      field_challenges: 'Core Strategy Challenges',
      field_challenges_hint: 'Select all that apply, or add your own',
      field_context: 'Additional Context (Optional)',
      field_team_size: 'Team Size',
      field_user_base: 'User Base',
      field_revenue_model: 'Revenue Model',
      field_competitive_landscape: 'Competitive Landscape',
      run_diagnostic: 'Run Strategy Diagnostic',
      report_title: 'Product Strategy Diagnostic Report',
      report_generating: 'Generating your strategy diagnostic...',
      report_done: 'Diagnostic complete',
      start_chat: 'Continue with Follow-up Chat',
      back_to_wizard: 'Edit Inputs',
      new_diagnostic: 'New Diagnostic',
  ...
  zh: {
    ...
    input: {
      placeholder: {
        ...
        job_match: '描述你理想的职位...',
        growth_coach: '针对增长诊断报告提出后续问题...',
        product_strategy: '针对策略诊断报告提出后续问题...',
      },
    ...
    job_match: {
      ...
      detail_search_google: '在 Google 搜索该职位',
      detail_via: '来自 {source}',
      posted_at: '{time}发布',
      ask_lenny: '问问 Lenny',
      lennys_take: 'Lenny 的看法',
      lenny_loading: '正在从 Lenny 的内容库中获取建议...',
      lenny_error: '无法获取 Lenny 的建议，知识库可能不可用。',
      lenny_retry: '重试',
      lenny_collapse: '收起',
      lenny_expand: '展开',
    ...
    growth_coach: {
      wizard_title: '增长诊断',
      wizard_subtitle: '回答几个关于你的产品和增长挑战的问题，我会基于 Lenny 78+ 篇增长相关内容为你生成个性化诊断报告。',
      field_product_type: '产品类型',
      field_product_desc: '产品描述',
      field_product_desc_placeholder: '简要描述你的产品是做什么的，服务谁...',
      field_growth_stage: '当前增长阶段',
      field_challenges: '核心增长挑战',
      field_challenges_hint: '选择所有适用的，或添加自定义挑战',
      field_metrics: '关键指标（可选）',
      field_dau: 'DAU',
      field_mau: 'MAU',
      field_d30_retention: 'D30 留存',
      field_conversion: '转化率',
      field_revenue: 'MRR / 收入',
      run_diagnostic: '开始增长诊断',
      report_title: '增长诊断报告',
    ...
    product_strategy: {
      wizard_title: '产品策略诊断',
      wizard_subtitle: '描述你的产品和策略挑战，我会基于 Lenny 130+ 篇产品策略相关内容为你生成个性化诊断报告。',
      field_strategy_area: '策略领域',
      field_product_desc: '产品描述',
      field_product_desc_placeholder: '你的产品是做什么的，服务谁？',
      field_product_maturity: '产品成熟度',
      field_challenges: '核心策略挑战',
      field_challenges_hint: '选择所有适用的，或添加自定义挑战',
      field_context: '补充信息（可选）',
      field_team_size: '团队规模',
      field_user_base: '用户规模',
      field_revenue_model: '商业模式',
      field_competitive_landscape: '竞争格局',
      run_diagnostic: '开始策略诊断',
      report_title: '产品策略诊断报告',
      report_generating: '正在生成策略诊断报告...',
      report_done: '诊断完成',
      start_chat: '继续追问',
      back_to_wizard: '修改输入',
      new_diagnostic: '重新诊断',
